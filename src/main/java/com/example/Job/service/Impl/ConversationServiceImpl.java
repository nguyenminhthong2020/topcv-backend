...
public class ConversationServiceImpl implements IConversationService {
    ...
    public ConversationServiceImpl(IMessageService messageService, IAccountService accountService, ModelMapper modelMapper, ConversationRepository conversationRepository) {
